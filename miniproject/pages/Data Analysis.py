...
# Histogram
fig_1 = px.histogram(df, x='Rented Bike Count', nbins=50, title="Distribution of Rented Bike Count")
fig_1.update_layout(bargap=0.2)
col1.plotly_chart(fig_1, use_container_width=True)
# Box plot
fig_2 = px.box(df, x='Rented Bike Count', title="Box Plot for Rented Bike Count")
...
fig2 = px.box(df, x=feature, y='Rented Bike Count', color=feature)
...
fig_1.update_layout(bargap=0.2)
col1.plotly_chart(fig_1, use_container_width=True)
fig_2 = px.box(df[df['Seasons'] == seasontype], y="Rented Bike Count")
col2.plotly_chart(fig_2, use_container_width=True)
st.write('Bike Rentals demand is highest in summer season and lowest in winter season.')

st.write('--------------------------------------------------------------------------------------')
col1, col2,col3 = st.columns(3)
fig_1 = px.bar(df,x='Month',y="Rented Bike Count" , title='Rented Bike Count by Months')
fig_1.update_layout(bargap=0.2)
col1.plotly_chart(fig_1, use_container_width=True)

fig_2 = px.bar(df,x='weekday',y="Rented Bike Count" , title='Rented Bike Count by WeekDay')
fig_2.update_layout(bargap=0.2)
col2.plotly_chart(fig_2, use_container_width=True)
st.write('Bike Rental demand is more in summer months like May, June, Jult etc compared to winter months like December, January, February etc.')
st.write("-----------------------------------------------------------------------------------")
