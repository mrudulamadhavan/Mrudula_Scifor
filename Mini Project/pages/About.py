...
#FILE_DIR = os.path.dirname(os.path.abspath("C://Users//Mrudula Madhavan//Desktop//scifor//Project//pages//About.py"))
FILE_DIR = os.path.dirname(os.path.abspath("Project//pages//About.py"))
